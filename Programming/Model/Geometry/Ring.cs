...
namespace Programming.Model.Geometry
{
    ...
    public class Ring
    {
        ...
        /// <summary>
        /// Возвращает и задает внешний радиус кольца. Значение должно быть положительным числом. 
        /// Значение должно быть больше внутреннего радиуса.
        /// </summary>
        ...
        /// <summary>
        /// Возвращает и задает внутренний радиус кольца. Значение должно быть положительным числом. 
        /// Значение должно быть меньше внешнего радиуса.
        /// </summary>
